...
SWIFT_CLASS("_TtC13MapsDirection11AppDelegate")
...
@interface UISearchBar (SWIFT_EXTENSION(MapsDirection))
- (void)setTextColorWithColor:(UIColor * _Nonnull)color;
@end
...
SWIFT_CLASS("_TtC13MapsDirection14ViewController")
@interface ViewController : UIViewController <GMSMapViewDelegate, CLLocationManagerDelegate>
@property (nonatomic, weak) IBOutlet GMSMapView * _Null_unspecified googleMaps;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified startLocation;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified destinationLocation;
@property (nonatomic, strong) CLLocationManager * _Nonnull locationManager;
@property (nonatomic, strong) CLLocation * _Nonnull locationStart;
@property (nonatomic, strong) CLLocation * _Nonnull locationEnd;
- (void)viewDidLoad;
- (void)createMarkerWithTitleMarker:(NSString * _Nonnull)titleMarker iconMarker:(UIImage * _Nonnull)iconMarker latitude:(CLLocationDegrees)latitude longitude:(CLLocationDegrees)longitude;
...
- (void)drawPathWithStartLocation:(CLLocation * _Nonnull)startLocation endLocation:(CLLocation * _Nonnull)endLocation;
- (IBAction)openStartLocation:(UIButton * _Nonnull)sender;
- (IBAction)openDestinationLocation:(UIButton * _Nonnull)sender;
- (IBAction)showDirection:(UIButton * _Nonnull)sender;
...
@interface ViewController (SWIFT_EXTENSION(MapsDirection)) <GMSAutocompleteViewControllerDelegate>
